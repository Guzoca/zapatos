...
<!-- end .sidebar1 --></div>
              <div class="content">
                <h1><!-- InstanceBeginEditable name="Titulo" -->Payment completition<!-- InstanceEndEditable --></h1>
                <!-- InstanceBeginEditable name="EditRegion4" -->
<?php if ($_POST["radio"] == 2)
	  { 
	  ConfirmacionPago($_POST["radio"]);
	  ?>
                <p>You have chosen bank tranfer payment.</p>
                <p>You must send an email with your payment confirmation to appstore@appstore.com.</p>
